...
class TravelExpenseReports(Base):
  ...
  service_engineer = relationship("User", foreign_keys=[service_engineer_ID], back_populates="travel_expenses")
  status_changer = relationship("User", foreign_keys=[status_by], back_populates="approved_expenses")
